...
```{r, fig.cap = "Estimates of time varying reproduction number"}

viz_Rt(model_ests, adm0) 

```

## Reported cases

The number of cases in the next 

```{r, fig.cap = "Estimate reported cases"}

rep_ests <- model_ests$estimates$summarised %>% filter(variable == "reported_cases") 

viz_reported_week(model_ests, adm0)
